...
async function handleMatch(req, res) {
  ...
  // The Jobs page is now members-only (gated in the page itself too) — enforced here as well so
  // the API can't just be called directly to bypass the sign-up gate.
